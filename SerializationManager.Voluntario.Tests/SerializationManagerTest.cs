...
namespace SerializationManager.Voluntario.Tests
{
    public class SerializationManagerTest
    {
        ...
        public void SerializeTest()
        {
            ...
            ICentralSerializationManager<IVoluntario> ser = new CentralSerializationManager<IVoluntario>();//new IoCManager.SerializationManager.Voluntario.SerializationIoCManager().GetISerializationCurrentImplementation();
